...
struct convert_all_impl {
    ...
    void operator()(const Params& t, Args& arguments) 
    {
        /*    
         ...
         It's replace previosule default-constructed object by new one.
        
        TODO:
         * In case of using scoped_ptr insetad of raw arguments types new need to allocate them on heap.
         ...
         * );
         * 
         * Used element_type is actual type stored in scoped_pointer. We need this to construct(convert to) proper value
         * beacuse cvt::conv is not specialized over scoped_ptr but over raw arguments types. In that case cnv should return pointer insetad of object by value.
        */
...
private:
    /*
      ...
      * TODO:
      * Each of those arguments need to be default consturtable, to remove this we
    ...
    */        
    void do_return(APIProvider* callee)
    {
        /*
            ...
            Callable is non-parameter function made from registered function by binding all arguments to to parameters.
        */
